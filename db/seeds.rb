...
puts "Event.destroy_all start..."require 'open-uri'
require 'json'
...
pierre = User.new(email: 'pierre@gmail.com', password: '12345678', first_name: "pierre", last_name: "jean", avatar: '', address: "17 boulevard clemenceau 35000 Rennes", bio: "On sait depuis longtemps que travailler avec du texte lisible et contenant du sens est source de distractions, et empêche de se concentrer sur la mise en page elle-même.")
pierre.photo.attach(io: URI.open("https://source.unsplash.com/random?man"), filename: "pierre.png", content_type: "image/png")
pierre.save!

sarah = User.new(email: 'sarah@gmail.com', password: '12345678', first_name: "sarah", last_name: "du desert", avatar: '', address: "35 rue kleber 33200 Bordeaux", bio: "On sait depuis longtemps que travailler avec du texte lisible et contenant du sens est source de distractions, et empêche de se concentrer sur la mise en page elle-même.")
sarah.photo.attach(io: URI.open("https://source.unsplash.com/random?woman"), filename: "sarahh.png", content_type: "image/png")
sarah.save!

nicolas = User.new(email: 'nicolas@gmail.com', password: '12345678', first_name: "nicolas", last_name: "petit", avatar: '', address: "4 rue des basques 64200 Bayonne", bio: "On sait depuis longtemps que travailler avec du texte lisible et contenant du sens est source de distractions, et empêche de se concentrer sur la mise en page elle-même.")
nicolas.photo.attach(io: URI.open("https://source.unsplash.com/random?man"), filename: "nicolas.png", content_type: "image/png")
nicolas.save!

louis = User.new(email: 'louis@gmail.com', password: '12345678', first_name: "louis", last_name: "lafonte", avatar: '', address: "60 rue de paradis 75010 Paris", bio: "On sait depuis longtemps que travailler avec du texte lisible et contenant du sens est source de distractions, et empêche de se concentrer sur la mise en page elle-même.")
louis.photo.attach(io: URI.open("https://source.unsplash.com/random?man"), filename: "louis.png", content_type: "image/png")
louis.save!

juliette = User.new(email: 'juliette@gmail.com', password: '12345678', first_name: "juliette", last_name: "Jetaime", avatar: '', address: "6 rue de la jussienne 75002 Paris", bio: "On sait depuis longtemps que travailler avec du texte lisible et contenant du sens est source de distractions, et empêche de se concentrer sur la mise en page elle-même.")
...
pierreEvent = Event.create(title: 'frendly Parisian Dinner', type: 'Dinner', address: '17 boulevard clemenceau 35000 Rennes', description: "Dinner with friends around cheese and wine", date: "12/06/2022", capacity: 10, user: pierre)
...
sarahEvent = Event.create(title: 'Learn Portuguese Food ', type: 'Cooking Class', address: '17 boulevard clemenceau 35000 Rennes', description: "Portuguese song eat and fun ", date: "28/06/2022", capacity: 5, user: sarah)
